...
#'     code mappings from the \href{https://ilostat.ilo.org/methods/concepts-and-definitions/classification-economic-activities/}{International Labour Organization}.
#' }
